...
- add the number of the test suite in the file name as well. For example, if you have a test suite for users, you could name the file `1-users.test.mjs`. This will make it easier to identify the purpose of the test file and its relation to the test suite.